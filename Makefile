...
test: $(OUT) _build_test_docker
	...
	docker run --user $(shell id -u):$(shell id -g) -e HOME=/home -v $(TEST_HOME):/home -v $(LOG_DIR):/log -w /home pytest-workflow bash -i -c "pytest --symlink --kwdof --wt 4 --basetemp '/log/'"
