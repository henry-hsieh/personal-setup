...
set __git_tcsh_completion_original_script = ${HOME}/.local/share/bash-completion/completions/git
set __git_tcsh_completion_script = ${HOME}/.local/share/scripts/git-completion.tcsh.bash
